    ...
    <section id="documents" className="py-8 md:py-12 lg:py-24">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute left-4 top-1/2 -translate-y-1/2 z-10 flex w-12 h-12 rounded-full bg-white border border-gray-200 shadow-md items-center justify-center hover:bg-gray-50"
          aria-label="이전"
        >
        ...
        <button
          ...
          className="absolute right-4 top-1/2 -translate-y-1/2 z-10 flex w-12 h-12 rounded-full bg-white border border-gray-200 shadow-md items-center justify-center hover:bg-gray-50"
          aria-label="다음"
        >
