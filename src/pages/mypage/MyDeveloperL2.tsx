    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900">캡챠 SaaS (L2)</h1>
            <p className="text-sm text-gray-500">손동작 + OCR 기반 멀티모달 실시간 검증 API</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border bg-white p-5 shadow-sm">
          ...
          <form onSubmit={handleCreate} className="flex flex-col gap-3 sm:flex-row">
            <input
              className="flex-1 rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-400"
              placeholder="서비스명 (예: MyApp L2)"
